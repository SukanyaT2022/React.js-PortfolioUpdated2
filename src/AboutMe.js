...
<h2 className='font-bold md:text-2xl text-xl pb-5 text-[#565656]'>Who I am & What Inspire me</h2>
...
<button className='bg-[#565656] text-white px-10 py-3 rounded-3xl my-7'>Contact Me</button>
        </div>
